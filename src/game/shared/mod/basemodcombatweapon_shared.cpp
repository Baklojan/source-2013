...
LINK_ENTITY_TO_CLASS( basemodcombatweapon, CBaseModCombatWeapon );

IMPLEMENT_NETWORKCLASS_ALIASED( BaseModCombatWeapon , DT_BaseModCombatWeapon )

BEGIN_NETWORK_TABLE( CBaseModCombatWeapon , DT_BaseModCombatWeapon )
...
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC( CBaseModCombatWeapon )
...
BEGIN_PREDICTION_DATA( CBaseModCombatWeapon )
END_PREDICTION_DATA()

extern ConVar sk_auto_reload_time;

CBaseModCombatWeapon::CBaseModCombatWeapon( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseModCombatWeapon::ItemHolsterFrame( void )
{
...
//-----------------------------------------------------------------------------
bool CBaseModCombatWeapon::Lower( void )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseModCombatWeapon::Ready( void )
{
	//Don't bother if we don't have the animation
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseModCombatWeapon::Deploy( void )
{
	// If we should be lowered, deploy in the lowered position
	// We have to ask the player if the last time it checked, the weapon was lowered
	if ( GetOwner() && GetOwner()->IsPlayer() )
	{
		CMod_Player *pPlayer = assert_cast<CMod_Player*>( GetOwner() );
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseModCombatWeapon::Holster( CBaseCombatWeapon *pSwitchingTo )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseModCombatWeapon::WeaponShouldBeLowered( void )
{
...
//-----------------------------------------------------------------------------
void CBaseModCombatWeapon::WeaponIdle( void )
{
...
// Output : float
//-----------------------------------------------------------------------------
float CBaseModCombatWeapon::CalcViewmodelBob( void )
{
...
//			viewmodelindex - 
//-----------------------------------------------------------------------------
void CBaseModCombatWeapon::AddViewmodelBob( CBaseViewModel *viewmodel, Vector &origin, QAngle &angles )
{
...
//-----------------------------------------------------------------------------
Vector CBaseModCombatWeapon::GetBulletSpread( WeaponProficiency_t proficiency )
{
	return BaseClass::GetBulletSpread( proficiency );
}

//-----------------------------------------------------------------------------
float CBaseModCombatWeapon::GetSpreadBias( WeaponProficiency_t proficiency )
{
	return BaseClass::GetSpreadBias( proficiency );
}
//-----------------------------------------------------------------------------

const WeaponProficiencyInfo_t *CBaseModCombatWeapon::GetProficiencyValues()
{
	return NULL;
}
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CBaseModCombatWeapon::GetDefaultProficiencyValues()
{
