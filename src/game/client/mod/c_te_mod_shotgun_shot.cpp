...
class C_TEModFireBullets : public C_BaseTempEntity
{
public:
	DECLARE_CLASS( C_TEModFireBullets, C_BaseTempEntity );
	DECLARE_CLIENTCLASS();
...
void C_TEModFireBullets::CreateEffects( void )
{
...
void C_TEModFireBullets::PostDataUpdate( DataUpdateType_t updateType )
{
...
IMPLEMENT_CLIENTCLASS_EVENT( C_TEModFireBullets, DT_TEModFireBullets, CTEModFireBullets );


BEGIN_RECV_TABLE_NOBASE( C_TEModFireBullets, DT_TEModFireBullets )
