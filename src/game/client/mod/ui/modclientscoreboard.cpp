...
// Purpose: Konstructor
//-----------------------------------------------------------------------------
CModClientScoreBoardDialog::CModClientScoreBoardDialog(IViewPort *pViewPort):CClientScoreBoardDialog(pViewPort)
{
}
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CModClientScoreBoardDialog::~CModClientScoreBoardDialog()
{
}
...
//-----------------------------------------------------------------------------
void CModClientScoreBoardDialog::PaintBackground()
{
...
//-----------------------------------------------------------------------------
void CModClientScoreBoardDialog::PaintBorder()
{
	int x1, x2, y1, y2;
...
//-----------------------------------------------------------------------------
void CModClientScoreBoardDialog::ApplySchemeSettings( vgui::IScheme *pScheme )
{
...
//-----------------------------------------------------------------------------
void CModClientScoreBoardDialog::InitScoreboardSections()
{
	m_pPlayerList->SetBgColor( Color(0, 0, 0, 0) );
	m_pPlayerList->SetBorder(NULL);
...
//-----------------------------------------------------------------------------
void CModClientScoreBoardDialog::UpdateTeamInfo()
{
	if ( g_PR == NULL )
		return;
...
//-----------------------------------------------------------------------------
void CModClientScoreBoardDialog::AddHeader()
{
	// add the top header
...
//-----------------------------------------------------------------------------
void CModClientScoreBoardDialog::AddSection(int teamType, int teamNumber)
{
	HFont hFallbackFont = scheme()->GetIScheme( GetScheme() )->GetFont( "DefaultVerySmallFallBack", false );
...
int CModClientScoreBoardDialog::GetSectionFromTeamNumber( int teamNumber )
{
	switch ( teamNumber )
	{
	case TEAM_COMBINE:
...
//-----------------------------------------------------------------------------
bool CModClientScoreBoardDialog::GetPlayerScoreInfo(int playerIndex, KeyValues *kv)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CModClientScoreBoardDialog::UpdatePlayerInfo()
{
