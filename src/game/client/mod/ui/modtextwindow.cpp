...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CModTextWindow::CModTextWindow(IViewPort *pViewPort) : CTextWindow( pViewPort )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CModTextWindow::SetVisible(bool state)
{
...
//-----------------------------------------------------------------------------
void CModTextWindow::ShowPanel(bool bShow)
{
	if ( bShow )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CModTextWindow::OnKeyCodePressed(KeyCode code)
{
...
//-----------------------------------------------------------------------------
void CModTextWindow::PaintBackground()
{
}
...
//-----------------------------------------------------------------------------
void CModTextWindow::PerformLayout()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CModTextWindow::ApplySchemeSettings( vgui::IScheme *pScheme )
{
