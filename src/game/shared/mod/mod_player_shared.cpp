...
const char *CMod_Player::GetPlayerModelSoundPrefix( void )
{
	return g_ppszPlayerSoundPrefixNames[m_iPlayerSoundType];
}

void CMod_Player::PrecacheFootStepSounds( void )
{
...
//-----------------------------------------------------------------------------
Vector CMod_Player::GetAttackSpread( CBaseCombatWeapon *pWeapon, CBaseEntity *pTarget )
{
	if ( pWeapon )
...
//-----------------------------------------------------------------------------
void CMod_Player::PlayStepSound( Vector &vecOrigin, surfacedata_t *psurface, float fvol, bool force )
{
