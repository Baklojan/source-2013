...
void CPlayerPickupController::Init( CBasePlayer *pPlayer, CBaseEntity *pObject )
{
	...
	CMod_Player *pOwner = (CMod_Player *)ToBasePlayer( pPlayer );
	if ( pOwner )
	{
...
void CPlayerPickupController::Shutdown( bool bThrown )
{
	...
	if ( m_pPlayer )
	{
		CMod_Player *pOwner = (CMod_Player *)ToBasePlayer( m_pPlayer );
		if ( pOwner )
		{
...
class CWeaponPhysCannon : public CBaseModCombatWeapon
{
public:
	DECLARE_CLASS( CWeaponPhysCannon, CBaseModCombatWeapon );
...
bool CWeaponPhysCannon::AttachObject( CBaseEntity *pObject, const Vector &vPosition )
{
	...
	CMod_Player *pOwner = (CMod_Player *)ToBasePlayer( GetOwner() );
